<?php
namespace Application\Theme\metzwood;
...
class PageTheme extends Theme implements ThemeProviderInterface
{
    ...
    {
        return t('A Vibrant Brands C5 Theme');
    }
    ...
    {
        return [
            ['title' => t('White Button'), 'menuClass' => '', 'spanClass' => 'white btn', 'forceBlock' => '-1'],
            ['title' => t('Green Button'), 'menuClass' => '', 'spanClass' => 'green btn', 'forceBlock' => '-1'],
             ['title' => t('Light Blue Button'), 'menuClass' => '', 'spanClass' => 'lite-blue btn', 'forceBlock' => '-1'],
             ['title' => t('Blue Button'), 'menuClass' => '', 'spanClass' => 'blue btn', 'forceBlock' => '-1'],
